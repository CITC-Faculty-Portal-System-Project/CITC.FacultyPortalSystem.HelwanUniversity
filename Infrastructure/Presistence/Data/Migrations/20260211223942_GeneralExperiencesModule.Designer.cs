...
namespace Presistence.Data.Migrations
{
    ...
    [Migration("20260211223942_GeneralExperiencesModule")]
    partial class GeneralExperiencesModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ExternalResearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExternalResearches");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LinkWithOtherResearch")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("MagazineOrConference")
                        .IsRequired()
                        .HasMaxLength(300)
                    ...
                    b.ToTable("InternalSystemResearches");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearchContributor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsFromHelwanUniversity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.ToTable("InternalSystemResearchesContributors");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearchContributorsResearches", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InternalSystemResearchContributorId")
                        .HasColumnType("int");

                    b.Property<int>("InternalSystemResearchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InternalSystemResearchId");

                    b.HasIndex("InternalSystemResearchContributorId", "InternalSystemResearchId");

                    b.ToTable("InternalSystemResearchesContributorsResearches");
                });
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ResearchContribution", b =>
                {
                    ...
                    b.Property<int>("ExternalResearchId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MemberOrcid")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("MemberPositionInSearch")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("ExternalResearchId");

                    b.HasIndex("MemberAcademicName");

                    b.ToTable("ResearchContributions");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ResearchIndex", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ResearchesIndices");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.Researcher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ResearcherResearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResearcherId", "ExternalResearchId");

                    b.ToTable("ResearchersResearches");
                });
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearch", b =>
                {
                    b.HasOne("Domain.Entities.FacultyMemberDataModule.FacultyMember", "FacultyMember")
                        .WithMany("InternalSystemResearches")
                        .HasForeignKey("FacultyMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearchContributorsResearches", b =>
                {
                    b.HasOne("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearchContributor", "InternalSystemResearchContributor")
                        .WithMany("Researches")
                        .HasForeignKey("InternalSystemResearchContributorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.AcademicDataModule.ResearchesModule.InternalSystemResearch", "InternalSystemResearch")
                        .WithMany("Contributors")
                        .HasForeignKey("InternalSystemResearchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InternalSystemResearch");

                    b.Navigation("InternalSystemResearchContributor");
                });

            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ResearchCite", b =>
                {
                    b.HasOne("Domain.Entities.AcademicDataModule.ResearchesModule.Researcher", "Researcher")
                        .WithMany("ResearchCites")
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.ResearchContribution", b =>
                {
                    b.HasOne("Domain.Entities.AcademicDataModule.ResearchesModule.ExternalResearch", "ExternalResearch")
                        .WithMany("Contributions")
                        .HasForeignKey("ExternalResearchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExternalResearch");
                });
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.Researcher", b =>
                {
                    b.HasOne("Domain.Entities.FacultyMemberDataModule.FacultyMember", "FacultyMember")
                        .WithOne("Researcher")
                        .HasForeignKey("Domain.Entities.AcademicDataModule.ResearchesModule.Researcher", "FacultyMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ScientificProgressionModule.AcademicQualifications", b =>
                {
                    b.HasOne("Domain.Entities.Attachments.AttachmentReference", "Attachment")
                        ...
                        .HasForeignKey("Domain.Entities.AcademicDataModule.ScientificProgressionModule.AcademicQualifications", "AttachmentId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domain.Entities.AcademicDataModule.ResearchesModule.Researcher", b =>
                {
                    b.Navigation("ExternalResearches");

                    b.Navigation("ResearchCites");
            ...
            modelBuilder.Entity("Domain.Entities.FacultyMemberDataModule.FacultyMember", b =>
                {
                    ...
                    b.Navigation("InternalSystemResearches");
