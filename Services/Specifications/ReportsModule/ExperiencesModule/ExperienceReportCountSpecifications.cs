...
{
    public class ExperienceReportCountSpecifications : BaseSpecifications<FacultyMember, Guid>
    {
        public ExperienceReportCountSpecifications
            (ExperinceReportTableSpecificationParameters parameters) 
            : base(fd =>
                !fd.IsDeleted
                &&
                (
