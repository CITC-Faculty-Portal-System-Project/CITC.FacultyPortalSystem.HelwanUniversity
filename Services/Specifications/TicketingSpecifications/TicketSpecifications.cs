...
{
    internal class TicketSpecifications : BaseSpecifications<Ticket, int>
    {
        public TicketSpecifications(int id) 
            :base(t => t.Id == id && !t.IsDeleted)
        {
        }

        public TicketSpecifications(TicketSepcificationParameters parameters)
                  : base(t =>
                !t.IsDeleted &&
                (
